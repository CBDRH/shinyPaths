...
The DAG shown here reflects this perspective. We can see the assumptions that Smoking increases the risk of Hospitalisation (X → Z) and Coronavirus increases the risk of Hospitalisation (Y → Z). The path X → Z ←  Y  is a non-causal path between Smoking and Coronavirus but importantly it is not an _open_ path. 
