...
golem::fill_desc(
  ...
  repo_url = "https://github.com/CBDRH/shinyPaths" # The URL of the GitHub Repo (optional) 
)     
...
golem::use_favicon(path = "inst/app/www/Line-Graph_41751.ico") # path = "path/to/ico". Can be an online file. # Downloaded from https://icon-icons.com/download/41751/ICO/256/
