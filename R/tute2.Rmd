...
```{r}
tags$p(
"If we are interested in the", tags$span(style="color:#4FBAE4; font-weight:bold", tippy('total effect', "The total effect of an exposure on an outcome includes direct effects like X → Y and indirect effects that pass thorugh one or more mediators, like X → Z → Y")) , "of Exercise on Mood regardless of which pathways it occurs through then we should make sure the path including sleep quality remains open.")
```
